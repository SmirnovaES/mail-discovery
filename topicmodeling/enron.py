...
part_path = '/home/geras-artem/Desktop/Study/6sem/InPrak/MailDiscoveryML/part'
model_path = '/home/geras-artem/Desktop/ldamodel_part1'


def main():
    model = LdaMulticoreModel(source=corpus_path)
    model.do_processing()
    # model.load(path=model_path)
    model.build(passes=20, workers=8, path=model_path)

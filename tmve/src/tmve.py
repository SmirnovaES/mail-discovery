...
def get_template(project_file):
    ...
    try:
        ...
        (errnum, strerror) = xxx_todo_changeme1.args
    ...
    for html_filename in html_filenames:
        ...
        if html_filename.endswith(".html"):
            ...
            if html_filename == "images" or html_filename == "js":
                shutil.copytree("src/templates/" + template_name + "/html/" + html_filename,
            ...
            for token in tokenset:
                ...
                xml_rigamroll(src_filepath, token_dst_filepath, token_html_strings, html_inserts, template, myrelations,
                              token)

...
def main():
    ...
    #model.build(num_topics=10, passes=20, path='/home/geras-artem/Desktop/ldamodel')
    ...
    Visualizer(docs_words, topics_words, topics_top_terms).run(path, metrics='tfIdf', proc_num=1)
